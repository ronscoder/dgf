...
export class DataServiceService {
  ...
  getContacts(): Observable<any> {
    ...
    return this.http.get("./app/data/contacts.json").map((res) => res.json())

  }

  getCarousal() {
    return this.http.get("./app/data/carousal.json").map((res) => res.json());
    // return Observable.from(StaticData.carousal_images);
  }

  getHighlights() {
    return this.http.get("./app/data/highlights.json").map((res) => res.json());
  ...
  getVisionText() {
    ...
    // });
    return this.http.get("./app/data/texts.json").map((res) => res.json().visionText);
  }

  getBoardMembers() {
    return this.http.get("./app/data/boardMembers.json").map((res) => res.json());
  }
