      ...
      for (let key in tasks) {
        ...
        this.tabledata.push(
          [
            ...
            // values[key].duration == "" ? null : +values[key].duration,
            null,
            tasks[key].percent_complete,
            tasks[key].dependencies != null ? tasks[key].dependencies.join(',') : null,
          ]);
      }
